...
//**********************************************************************
        ...
        Romance.add(catergoriaItem(1,"https://i.pinimg.com/originals/a6/8a/f5/a68af5cfa0b478115ab948e7fd13fac4.jpg"))
        Romance.add(catergoriaItem(1,"https://cdn6.dibujos.net/images/listas/85/starstuck.jpg"))
        Romance.add(catergoriaItem(1,"https://es.web.img3.acsta.net/pictures/20/04/08/16/58/5970002.jpg"))
        Romance.add(catergoriaItem(1,"https://i.pinimg.com/originals/38/ce/07/38ce07897928de01cab6f6ac31456f8c.jpg"))
        Romance.add(catergoriaItem(1,"https://i.pinimg.com/564x/06/e7/b3/06e7b31da676fd1c7b88dfd317091bc5.jpg"))
        Romance.add(catergoriaItem(1,"http://pm1.narvii.com/6604/64ec8d1c8af8d95f2550089773fcff86cc9d2d9b_00.jpg"))
        Romance.add(catergoriaItem(1,"https://elcomercio.pe/resizer/YomkRXg9qomviNw2zx797287SjY=/980x0/smart/filters:format(jpeg):quality(75)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/MCKMWB7IAVHUPOH4K2RHVSALMA.png"))
        Romance.add(catergoriaItem(1,"https://c8.alamy.com/compes/ghjfg1/verwunscht-filmplakat-regie-kevin-lima-aka-enchanted-ghjfg1.jpg"))

        val MusicaBaile: MutableList<catergoriaItem> = ArrayList()
        MusicaBaile.add(catergoriaItem(1,"https://i.pinimg.com/originals/fd/35/5e/fd355ef327532e2b028d702fc41db728.jpg"))
        MusicaBaile.add(catergoriaItem(1,"http://4.bp.blogspot.com/-aCSxrtnEcNc/UkSLIPGHBMI/AAAAAAAAAvI/oMrOOSn1sJU/s640/LOL.jpg"))
        MusicaBaile.add(catergoriaItem(1,"https://coo2.tuvotacion.com/imagenes_unicas/vota-por-tu-pelicula-favorita-de-disney-284746.jpg"))
        MusicaBaile.add(catergoriaItem(1,"https://assets.afcdn.com/album/D20150901/phalbm24550453_w320.jpg"))
        MusicaBaile.add(catergoriaItem(1,"https://www.okchicas.com/wp-content/uploads/2020/04/Elenco-de-HSM-transmitir%C3%A1-concierto-online-2.jpg"))
        MusicaBaile.add(catergoriaItem(1,"https://static.wikia.nocookie.net/disney/images/6/6f/Hsm2.jpg/revision/latest/top-crop/width/360/height/450?cb=20110310061730&path-prefix=es"))
        MusicaBaile.add(catergoriaItem(1,"https://static.wikia.nocookie.net/doblaje/images/4/4a/Hsm3-la-graduacion.jpg/revision/latest/top-crop/width/360/height/450?cb=20200712235916&path-prefix=es"))
        MusicaBaile.add(catergoriaItem(1,"https://www.planetadelibros.com.ec/usuaris/libros/fotos/271/m_libros/270226_portada_soy-luna-10-secretos-del-pasado_disney_201805221834.jpg"))

        val MickeyComapania: MutableList<catergoriaItem> = ArrayList()
        MickeyComapania.add(catergoriaItem(1,"https://m.media-amazon.com/images/M/MV5BMTdiNDIyMGEtNWJjMi00ODlhLWJhM2EtYjJjMjFlMjNhNDEwXkEyXkFqcGdeQXVyODg3NDc1OTE@._V1_.jpg"))
        MickeyComapania.add(catergoriaItem(1,"https://m.media-amazon.com/images/I/81rrF1A6L+L._SL1500_.jpg"))
        MickeyComapania.add(catergoriaItem(1,"https://static.wikia.nocookie.net/disney/images/4/45/Mickey_Mouse_Funhouse_poster.jpg/revision/latest?cb=20210629051319&path-prefix=es"))
        MickeyComapania.add(catergoriaItem(1,"https://lumiere-a.akamaihd.net/v1/images/p_mickeymouseclubhouseadventuresinwonderland_19892_3b402c74.jpeg"))
        MickeyComapania.add(catergoriaItem(1,"https://m.media-amazon.com/images/M/MV5BODRlNTk4ZDktNzg4NC00MWRmLWE0ODctOWRkNTE1MGEyNTk5XkEyXkFqcGdeQXVyMzM4NjcxOTc@._V1_FMjpg_UX1000_.jpg"))
        MickeyComapania.add(catergoriaItem(1,"https://bestsimilar.com/img/movie/thumb/9e/5171.jpg"))
        MickeyComapania.add(catergoriaItem(1,"https://m.media-amazon.com/images/M/MV5BMmRkMDFkMjItZTkzOC00ZGYxLWIxYTYtZTI0OWY0ZWQzYTEzXkEyXkFqcGdeQXVyNDgyODgxNjE@._V1_.jpg"))
        MickeyComapania.add(catergoriaItem(1,"https://i.pinimg.com/474x/fa/00/25/fa00251f91ae4daa97f7ad57ccbab8a0.jpg"))
        MickeyComapania.add(catergoriaItem(1,"https://upload.wikimedia.org/wikipedia/en/e/ee/Mickey%27s_House_of_Villains.jpg"))

        val ExitosCine: MutableList<catergoriaItem> = ArrayList()
        ExitosCine.add(catergoriaItem(1,"https://lumiere-a.akamaihd.net/v1/images/unnamed_7_61143ce7.jpeg"))
        ExitosCine.add(catergoriaItem(1,"https://lumiere-a.akamaihd.net/v1/images/p_rayaandthelastdragon_es_06f8daf0.jpeg"))
        ExitosCine.add(catergoriaItem(1,"https://media.gq.com.mx/photos/6089777c7a5da02e8a3dbf76/master/pass/original_1619620187_LUCA%20Disney+.png"))
        ExitosCine.add(catergoriaItem(1,"https://lumiere-a.akamaihd.net/v1/images/536x0w_c5f00b09.jpeg"))
        ExitosCine.add(catergoriaItem(1,"https://lumiere-a.akamaihd.net/v1/images/movie_poster_zootopia_866a1bf2.jpeg"))
        ExitosCine.add(catergoriaItem(1,"https://lumiere-a.akamaihd.net/v1/images/en_disney-plus_poster_soul_r_b083e81b.jpeg?region=0,0,480,711"))
        ExitosCine.add(catergoriaItem(1,"https://images-2.wuaki.tv/system/artworks/10419/original/el-viaje-de-arlo-1611322112-width217-quality80.jpeg"))
        ExitosCine.add(catergoriaItem(1,"https://lumiere-a.akamaihd.net/v1/images/image_4f447b1d.jpeg?region=0,0,540,810"))
        ExitosCine.add(catergoriaItem(1,"https://aws.glamour.mx/prod/designs/v1/assets/675x1000/8976.jpg"))
